...
from nba_bets.src.data_processing.features_table import (
    GAMES_FEATURES_PATH,
)
from nba_bets.src.data_processing.games_class import Game
...
def main():
    ...
    with open("../data/train_prompt.pkl", "wb") as file:
        pickle.dump(train, file)

    with open("../data/validation_prompt.pkl", "wb") as file:
        pickle.dump(validation, file)

    with open("../data/test_prompt.pkl", "wb") as file:
