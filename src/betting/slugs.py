...
A slug (``nba-bos-lal-2026-02-09``) identifies a game's Polymarket market. It is
the join key between our gameIds and market data, so it is shared by the bet
placement path and by any historical-odds backfill.
"""
